...
<style>
  ...
  [data-testid=\"stDataFrame\"] table th {{ padding:0.75rem!important; line-height:1.4!important; }}
  [data-testid=\"stDataFrame\"] table td {{ padding:0.5rem!important; }}
  /* Extra spacing for headers */
  h1, h2 {{ margin:1.5rem 0 0.75rem!important; line-height:1.2!important; }}
</style>
"""
...
# ───── PropStream Leads ─────
    ...
    if st.button("🗑️ Delete ALL PropStream Listings"):
