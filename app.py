...
# ─── Dashboard page ─────────────────
    ...
    # Original chart + thicker grid lines
    chart = (
    ...
    chart = chart.configure_axisX(gridWidth=2).configure_axisY(gridWidth=2)
...
# ─── Settings page ────────────────
    ...
    st.write(
        "The **Settings** page is informational only—it shows the schema your database must have; it does not modify data or behavior."
    )